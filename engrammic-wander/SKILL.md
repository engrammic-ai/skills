...
Genuine sense-making, not task completion.

## First

Invoke `/engrammic:eag-guide` to learn how to use Engrammic memory.
...
## No checklist. No quota.

Explore until you genuinely understand something meaningful. Quality over quantity. Take your time.

## Tagging

If given a tag (e.g. `tag=somnus`), include it in all Engrammic calls so findings are queryable later.
